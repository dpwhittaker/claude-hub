...
// never asked to repeat a string it might paraphrase.
function buildPrompt({ turns, current, cwd, userNamed = false }) {
  return [
    'You name coding sessions for a dashboard tab.',
    current
...
// The model's reply → a new title, or null for "keep".
...
module.exports = { digestTranscript, buildPrompt, parseReply, textOf, TITLE_MODEL, MAX_TURNS, USER_NAME_FLOOR, KEEP };
